...
LowPassFilter2::LowPassFilter2() : Filter(), _y_1(0), _y_2(0), _x_1(0) {}
LowPassFilter2::LowPassFilter2(float f, float m) : Filter(f,m), _y_1(0), _y_2(0), _x_1(0) {}
...
void LowPassFilter2::step(Signal* inout)
{
  ...
  for (int i=0;i < Signal::size;i++)
  {
    ...
    samples[i] = a0*samples[i]-a0*_x_1+b1*_y_1-b2*_y_2;
    _y_2 = _y_1;
    _y_1 = samples[i];
    _x_1 = save_x_1;
  }
